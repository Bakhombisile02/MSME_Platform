...
const ServiceCategoryTable = ({ data, onEdit, onDelete, page, totalPages, handleNextPage, handlePrevPage, loading }) => {
          ...
          <>
            {data.length === 0 ? (
              <div className="text-center py-16 bg-white">
                ...
                <h3 className="text-primary-950 text-lg font-medium mb-1">No Service Category found</h3>
                <p className="text-primary-950/70 mb-6">Add a new Service Category to get started</p>
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-800 font-medium">{selectedCategory.name}</p>
                </div>
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium text-gray-500">Description</p>  
                <div
                  dangerouslySetInnerHTML={{ __html: sanitizeHTML(selectedCategory.description) }}
