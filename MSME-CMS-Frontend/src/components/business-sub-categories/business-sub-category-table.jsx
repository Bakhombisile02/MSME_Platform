...
const BusinessSubCategoryTable = ({ data, onEdit, onDelete,  page, totalPages, handleNextPage, handlePrevPage, loading }) => {
  console.log("BusinessSubCategoryTable data:", data);
  return (
    <>
          ...
          <>
            {data.length === 0 ? (
              <div className="text-center py-16 bg-white">
                ...
                <h3 className="text-primary-950 text-lg font-medium mb-1">No business categories found</h3>
                <p className="text-primary-950/70 mb-6">Add a new business category to get started</p>
                ...
                <table className="min-w-full text-sm">
                  <thead className="bg-primary-950/5 py-5">
                    <tr className="text-left text-sm font-semibold text-primary-950 border-b border-primary-950/10">
                      ...
                      <th className="py-4 pl-3 text-left font-medium tracking-wider">Sub Category Name</th>
                      <th className="py-4 pl-3 text-left font-medium tracking-wider">Category Name</th>
...
export default BusinessSubCategoryTable;